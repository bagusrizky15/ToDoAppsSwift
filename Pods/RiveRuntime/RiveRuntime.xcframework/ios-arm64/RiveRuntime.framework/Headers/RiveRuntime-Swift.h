...
SWIFT_PROTOCOL("_TtP11RiveRuntime17RiveTouchDelegate_")
@protocol RiveTouchDelegate
@optional
...
@interface RiveView (SWIFT_EXTENSION(RiveRuntime)) <RArtboardDelegate>
/// Events triggered in the RiveArtboard by user input
- (void)artboard:(RiveArtboard * _Nonnull)artboard didTriggerEvent:(NSString * _Nonnull)event;
